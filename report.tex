...
We found the ideality factor to be $n = \frac{|q|V_0}{k_BT} = 1.93$, which can be compared to $1$, the value of an ideal diode. The occurrence of recombination of electrons and holes could account for some discrepance. We finally note that there was a current even at zero bias. This is because ambient light was present, which made the solar cell produce electricity. \\
