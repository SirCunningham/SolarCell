...
We first made a measurement with the lamp turned off and observed that the current was next to zero, as expected; see figure \ref{ivsun} for reference. We next performed a measurement with the lamp turned on and observed a sine curve with period $10$ ms, which corresponds to a frequency of $100$ Hz; see figure \ref{ivsui}. This was also expected, since a standard wall outlet outputs an alternating current at $50$ Hz, implying that the output of the lamp has a frequency of $100$ Hz.\\

We now set the Power Cassy to produce triangular waves with amplitude $0.57$ V and frequency $0.2$ Hz. Once again, we made measurements with the lamp turned off and then with the lamp turned on. We averaged the current $I_{av}$ over $10$ ms to eliminate the sine like curve due to the wall outlet. \\
...
\begin{figure}[h!]
  ...
  \end{center}
  \caption{Current as function of voltage without illumination. Fitted according to the diode equation.}
  \label{ivsun}
\end{figure}

\begin{figure}[h!]
  \begin{center}
    \includegraphics[scale=0.07]{vaxelIntro.png}
  \end{center}
  \caption{Current as function of time with illumination.}
  \label{ivsui}
\end{figure}
...
Our solar cell, consisting of silicon, with an energy gap of around $1.11$ eV at $300$ K is therefore an excellent choice. \\
...
The area of the solar cell was $13.8$ cm${}^2$ and as a rough approximation, assume that the $60$ W light bulb converts all of its energy into radiation. Assume that the light is spherically distributed and perfectly aligned with the solar cell. Then, at a distance of $37.5$ cm, $13.8\cdot 60/(2\pi 37.5^2)\approx 0.088$ W will be absorbed by the solar cell, where we assume that the light is confined to a hemisphere.
Thus, by table \ref{tab}, the efficiency is
\begin{displaymath}
  \frac{0.033}{0.044}\approx 0.37,
\end{displaymath}
