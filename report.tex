...
In figure \ref{ivsun}, least square fitting gave the values $I_{sat}=1.78\cdot 10^{-6}$ A and $V_0=0.0498$ V in the diode equation giving the ideal factor $n=\frac{eV_0}{k_B T}=1.9$.
\begin{figure}[h!]
  \begin{center}
