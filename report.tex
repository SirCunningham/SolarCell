...
From figure \ref{pvsv}, we see that $U_{max}\approx -0.4$ V and from figure \ref{ivsu}, we see that $U_0\approx 0.5$ V, which does not at all agree with theory. (WHY??????) \\
...
In this report, we considered a $60$ W light bulb with an effective temperature around $3000$ K. This implies that $E_g/(k_B T)\approx 4.3$ so that theory gives us an efficiency of $25$\%.
...
We also note that our methology was not free of errors. We approximated the distribution of the light from the lamp as spherical, while in reality a lampshade focused the light into a cone.
